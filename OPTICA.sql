...
recomendation_id varchar(50) default null,
primary key(client_id)
)ENGINE=InnoDB;

insert into clients values (1, 'Pedro Lopéz', 6, '555555555', null, '2022,01,13', null);
insert into clients values (2,'Xavi Muñoz', 7, '333333333', 'xavi@hotmail.com','2021,08,4','Laura Pérez'  );
insert into clients values (3, 'Laura Pérez', 8, '111111111', 'laura@gmail.com', '2022,07,05', 'Claudio Naranjo');
